...
[t1,y1]=ode23s(@model_tcs_overall_new,[0 10000],IC,[],par2,k_deg_I,k_pstase,Input); 

figure(h1)
hold on; box on
mm(kkk) = plot([0 tau(kkk) tau(kkk)+0.001 t_max],[Input Input 0 0],'color',col(kkk,:));
...
IC = zeros(23,1); IC(1) = HK1_unact; IC(5) = RR1; IC(7) = RR2; 

[t2,y2]=ode23s(@model_tcs_overall_new,[0 10000],IC,[],par2,k_deg_I,k_pstase,Input);
