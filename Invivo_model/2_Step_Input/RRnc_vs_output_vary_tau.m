...
%%
figure(1)
a1 = legend({'\tau = 200','\tau = 500','\tau = 1000'},'FontSize',7,'Location','Best');
...
print(h1,['RRnc_vs_Omax_vary_tau.pdf'],'-dpdf','-r300')
savefig(h1,['RRnc_vs_Omax_vary_tau.fig'])
...
print(h2,['RRnc_vs_Otot_vary_tau.pdf'],'-dpdf','-r300')
savefig(h2,['RRnc_vs_Otot_vary_tau.fig'])