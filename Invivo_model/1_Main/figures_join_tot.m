...
openfig('I_vs_Otot.fig','reuse');ax3 = gca; 
openfig('RRnc_vs_Otot_vary_I.fig','reuse');ax4 = gca; 
openfig('tau_vs_Otot.fig','reuse');ax5 = gca; 
openfig('RRnc_vs_Otot_vary_tau.fig','reuse');ax6 = gca; 
...
h=figure('position',[50 50 170*mm2pix 150*mm2pix],'DefaultLegendFontSize',6,'DefaultLegendFontSizeMode','manual');
tcl=tiledlayout(3,3,'TileSpacing','tight','Padding','tight');
...
print(h,'all_tot.pdf','-dpdf')
savefig(h,'all_tot.fig')