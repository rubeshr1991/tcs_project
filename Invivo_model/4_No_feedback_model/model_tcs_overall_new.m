...
dx(1) = k_unact*HK1 - k_act_I*HK1_unact*Input + lambda*beta*PT*(1+alpha*RR1s^2/K1)/(1+RR1s^2/K1)...
    - k_deg*HK1_unact -k_dp11*RR1s*HK1_unact + k_ps11*HK1_unact_RR1s + k_ps12*HK1_unact_RR2s; 

dx(2) = - k_fa1*HK1*ATP + k_fa1/K_E*HK1_ATP - k_unact*HK1 + k_act_I*HK1_unact*Input + k_pt11*HK1_RR1s...
    - k_dp11*HK1*RR1s + k_ps11*HK1_RR1s + k_ps12*HK1_RR2s...
...
dx(9) = k_f1*HK1s*RR1 - k_f1*K_D1*HK1s_RR1 - k_fc*HK1s_RR1 + k_fc*K_c*HK1_RR1s...
    - k_unact*HK1s_RR1 + k_act_I*HK1s_unact_RR1*Input  - k_deg*HK1s_RR1;

dx(10) = k_fc*HK1s_RR1 - k_fc*K_c*HK1_RR1s - k_pt11*HK1_RR1s + k_dp11*HK1*RR1s...
    - k_ps11*HK1_RR1s - k_unact*HK1_RR1s + k_act_I*HK1_unact_RR1s*Input - k_deg*HK1_RR1s;
