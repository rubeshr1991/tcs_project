...
pos = get(h,'Position');
set(h,'PaperPositionMode','Auto','PaperUnits','inches','PaperSize',[pos(3), pos(4)])
print(h,'Fit_PdtaR_2.png','-dpng','-r300')
...
pos = get(h,'Position');
set(h,'PaperPositionMode','Auto','PaperUnits','inches','PaperSize',[pos(3), pos(4)])
print(h,'Fit_PdtaR_no_errbar_2.png','-dpng','-r300')
%%
load('Fit2_se.mat')
